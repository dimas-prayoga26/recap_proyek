...
Route::middleware('auth')->group(function (): void {
    ...
    Route::get('/kurs/usd-idr', [ExchangeRateController::class, 'usdToIdr'])->name('kurs.usd-idr');
    ...
    Route::patch('/termin-pembayaran/{paymentTerm}/rincian', [PaymentTermController::class, 'updateServiceDetail'])->name('termin-pembayaran.rincian.update');
